function renderData(vehicles) {
    ...
    vehicles.forEach(vehicle => {
      ...
      element2.textContent =  ` ${vehicle.length}`;
      element3.textContent =  ` ${vehicle.cost_in_credits}`;
      element4.textContent =  ` ${vehicle.manufacturer}`;
      element5.textContent =  ` ${vehicle.passengers}`;
